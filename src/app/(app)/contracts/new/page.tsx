        ...
        <div className="flex items-center gap-2">
          {[1, 2, 3].map((s: number) => (
            <div key={s} className={cn(
              ...
              step >= s
                ? "w-8 h-2 bg-emerald shadow-[0_0_12px_#10775e]"
                : "w-2 h-2 bg-ink/10"
            )} />
          ))}
        </div>
        ...
        {step === 1 && !showChatImport && (
          ...
          >
            <div className="space-y-2">
              ...
              <h1 className="text-3xl sm:text-4xl font-semibold text-ink tracking-tight ">Agreement Details.</h1>
            </div>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <p className="text-[10px] font-black text-ink/30 uppercase tracking-[0.4em]">Agreement Title</p>
                <input
                  autoFocus
                  type="text"
              ...
              <div className="space-y-2">
                <p className="text-[10px] font-black text-ink/30 uppercase tracking-[0.4em]">Describe the Agreement (optional)</p>
                <textarea
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <p className="text-[10px] font-black text-ink/30 uppercase tracking-[0.4em]">Total Value (USD)</p>
                  <input
                    type="number"
                    placeholder="0.00"
              ...
              <div className="space-y-2">
                <p className="text-[10px] font-black text-ink/30 uppercase tracking-[0.4em]">Jurisdiction (optional)</p>
                <input
                  type="text"
        ...
        {step === 2 && (
          ...
          >
            <div className="space-y-2">
              ...
              <h1 className="text-3xl sm:text-4xl font-semibold text-ink tracking-tight ">Stakeholders.</h1>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              <div className="p-6 rounded-3xl bg-ink/[0.03] border border-line space-y-5 relative overflow-hidden group hover:border-emerald/40 transition-all duration-500">
                ...
                <div className="space-y-2">
                  <p className="text-[10px] font-black text-ink/30 uppercase tracking-[0.4em]">Primary Party (You)</p>
                  <input
                    type="text"
                    placeholder="Your name or entity"
                    className="w-full bg-transparent border-b-2 border-line pb-2 text-lg font-black text-ink uppercase tracking-tight focus:border-emerald transition-all outline-none placeholder:text-ink/15"
              ...
              <div className="p-6 rounded-3xl bg-ink/[0.03] border border-line space-y-5 relative overflow-hidden group hover:border-blue/40 transition-all duration-500">
                ...
                <div className="space-y-2">
                  <p className="text-[10px] font-black text-ink/30 uppercase tracking-[0.4em]">Counter Party</p>
                  <input
                    type="text"
                    placeholder="Their name or entity"
                    className="w-full bg-transparent border-b-2 border-line pb-2 text-lg font-black text-ink uppercase tracking-tight focus:border-blue transition-all outline-none placeholder:text-ink/15"
            ...
            <div className="pt-6 border-t border-line flex items-center justify-between">
              <button onClick={() => setStep(1)} className="text-[11px] font-black text-ink/30 uppercase tracking-[0.4em] hover:text-ink transition-all flex items-center gap-2">
            ...
            {loading ? (
              <div className="space-y-8 relative z-10 flex flex-col items-center px-8">
                ...
                <div className="space-y-3">
                  <h4 className="text-2xl font-semibold text-ink tracking-tighter">{loadingMsg}</h4>
              ...
              <div className="space-y-10 relative z-10 px-8">
                ...
                <div className="space-y-4">
                  <h2 className="text-3xl sm:text-4xl font-semibold text-ink tracking-tighter ">Ready to <span className="text-emerald">Finalize</span>.</h2>
                ...
                <div className="text-left bg-ink/[0.03] border border-line rounded-2xl p-5 space-y-3 max-w-md mx-auto">
                  {[
                    ...
                    <div key={row.label} className="flex justify-between items-center gap-4">
                      <span className="text-[9px] font-black text-ink/30 uppercase tracking-widest">{row.label}</span>
                      <span className="text-[11px] font-black text-ink truncate">{row.val}</span>
                    </div>
                  ))}
                </div>
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <button onClick={() => setStep(2)} className="text-[11px] font-black text-ink/25 uppercase tracking-[0.3em] hover:text-ink transition-all flex items-center gap-2">
