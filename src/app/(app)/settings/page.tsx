...
export default function SettingsPage() {
  ...
  if (!mounted || !isLoaded) return <div className="min-h-screen bg-ground" />;
    ...
    <div className="space-y-7 pb-24 max-w-5xl mx-auto">
      ...
      <header className="pb-6 border-b border-line">
        <motion.div initial={{ opacity: 0, x: -14 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
          ...
          <h1 className="text-2xl sm:text-3xl font-semibold text-ink tracking-tight ">Settings.</h1>
        </motion.div>
      </header>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-6">
                <h2 className="text-base font-black text-ink uppercase tracking-tight">{activeTab}</h2>
              ...
              {activeTab === 'Profile' && (
                <div className="space-y-5">
                    ...
                    {[
                      ...
                      <div key={stat.label} className="p-4 rounded-xl bg-ink/[0.02] border border-line flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs font-black text-ink/70 mt-0.5">{stat.value}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="space-y-2 pt-2">
                    <p className="text-[10px] font-black text-ink/25 uppercase tracking-widest mb-3">Preferences</p>
                    {[
              ...
              {activeTab !== 'Profile' && (
                <div className="py-16 flex flex-col items-center gap-4 text-center">
                  ...
                  <p className="text-[11px] text-ink/15 max-w-xs">This section is under development. Check back soon for {activeTab.toLowerCase()} settings.</p>
