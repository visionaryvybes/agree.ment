    ...
    <div className="max-w-2xl mx-auto pb-20 pt-12 min-h-[80vh] flex flex-col justify-center relative">
      ...
      <AnimatePresence mode="wait">
        {step === 1 && (
          ...
          >
             <div className="w-28 h-28 mx-auto rounded-full bg-emerald text-paper flex items-center justify-center rotate-[-8deg] shadow-lg">
                <SealCheck size={52} weight="duotone" />
             </div>
             ...
             <div className="space-y-8">
                 ...
                 <p className="text-ink/50 text-base font-medium max-w-md mx-auto leading-relaxed">
                    Welcome, <span className="text-ink font-black">{user?.firstName || 'there'}</span>. Let's secure your workspace.
                 </p>
             </div>
